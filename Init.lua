...
EventUtil.ContinueOnAddOnLoaded(addonName, function()
	...
	PixelUtil.SetPoint(frame, "BOTTOM", EssentialCooldownViewer, "TOP", 0, 4)
	...
	function frame:UpdateBarColors(currentPower)
		...
		local spenderCost = self.specId == 1467 and 3 or 2
	...
	function frame:Relayout()
		...
		for i = 1, 6 do
			...
			PixelUtil.SetPoint(statusBar, "LEFT", self, "LEFT", (i - 1) * (individualBarWidth + padding), 0)
			PixelUtil.SetSize(statusBar, individualBarWidth, 12)
	...
	PixelUtil.SetSize(frame, EssentialCooldownViewer:GetWidth(), 10)
	...
	EssentialCooldownViewer:HookScript("OnSizeChanged", function()
		...
		PixelUtil.SetSize(frame, nextWidth, 10)
	...
	frame:SetScript("OnEvent", function(self, event, ...)
		...
		elseif event == "UNIT_SPELLCAST_SUCCEEDED" then
			...
			elseif self.spenders[spellId] ~= nil then
